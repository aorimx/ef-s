<?php require 'header.php';?>
  <div class="container-fluid">
    <div class="row header-proveedores bg-attach">
      <h1 class="titulos-banner">Certificaciones _</h1>
    </div>
  </div>
  <div class="container">
    <div class="row div-proposito-certificaciones">
        <div class="col-xs-12 col-lg-10 col-lg-offset-1 div-certificaciones">
          <div class="imgCertificaciones">
            <img class="imgC" src="img/certificaciones/Logo1.png">
          </div>
          <div class="textCertificaciones">
            <p class="p-m">La Cooperación Internacional de Acreditación de Laboratorios, ILAC (por sus siglas en inglés).</p>
          </div>
          
        </div>
        <div class="col-xs-12 col-lg-10 col-lg-offset-1 div-certificaciones">
          <div class="imgCertificaciones">
            <img class="imgC" src="img/certificaciones/Logo2.png">
          </div>
          <div class="textCertificaciones">
            <p class="p-m">Grupo TÜV SÜD es Líder Mundial: GARANTÍA DE CALIDAD. TÜV SÜD la marca y el octágono azul representan mundialmente mas seguridad y mas valor económico.</p>
          </div>
