<?php require 'header.php';?>
  <div class="container-fluid">
    <div class="row header-productos bg-attach">
      <h1 class="titulos-banner">Productos _</h1>
    </div>
  </div>
  <div class="container">
      ...
      <div class="items-content">
        ...
        <div class="col-xs-6 col-sm-4 tRes">
          ...
          <div class="flag-text6 parrafo-deploy">
              ...
              <p>Capacidades de carga desde 50 kg hasta 300 kg.</p>
              <p>Accesos o ingresos desde 40 cm hasta 1 m.</p>
              <p>Oportunidad de ingresos a 2 frentes.</p>
              <p>Posibilidad de adaptación con o sin cuarto de máquinas.</p>
              <p>Opción de desarrollo e instalación sin preparaciones arquitectónicas previas.</p>
              <p class="p-bold">Compatibilidad eléctrica MONO FASICA, BI-FASICA Y TRI–FASICA.</p>
          </div>
        </div>
      </div>
      <div class="items-content">
        <div class="col-xs-6 col-sm-4 tRes">
          ...
          <div class="flag-text7 parrafo-deploy">
              ...
              <p>Capacidades de carga desde 2000 kg hasta 6000 kg.</p>
              <p>Accesos o ingresos desde 1 m hasta 2.50 m.</p>
              <p>Oportunidad de ingresos a 2 frentes.</p>
              <p>Posibilidad de adaptación con o sin cuarto de máquinas.</p>
          </div>
        </div>
        <div class="col-xs-6 col-sm-4 tRes">
          ...
          <div class="flag-text8 parrafo-deploy">
              ...
              <p>Altura max. de levante 2.10 m.</p>
              <p>Velocidad mínima de recorrido 26 segundos.</p>
              <p>Voltaje requerido 220 Volts AC.</p>
              <p>Operación electrohidráulica.</p>
              <p>Seguros electromecánicos.</p>
              <p>Descenso manual.</p>
  ...
  <script src="js/deployProducts.js"></script>
